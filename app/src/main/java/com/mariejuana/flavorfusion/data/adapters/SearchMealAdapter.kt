...
class SearchMealAdapter(private var mealList: ArrayList<SearchMeal>, private var context: Context, var mealAdapterCallback: MealAdapterInterface): RecyclerView.Adapter<SearchMealAdapter.MealViewHolder>(), Serializable {
    interface MealAdapterInterface {
        fun addFaveFood(username: String, meal: SearchMeal)
    }
    ...
    fun updateMeal(mealList: ArrayList<SearchMeal>){
